...
import { MessageSquare, RefreshCw, BarChart2, ClipboardList, TrendingUp, FileText, Loader2, ArrowRight } from "lucide-react"
...
export default function HomePage() {
  ...
  useEffect(() => {
    async function load() {
      const [docRes, finRes, projRes] = await Promise.allSettled([
